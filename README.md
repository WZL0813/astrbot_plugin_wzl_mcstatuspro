...
```bash
# 全球/海外/港澳台
 git clone https://github.com/WZL0813/astrbot_plugin_wzl_mcstatus.git  

# 大陆地区#1
git clone https://gh-proxy.com/https://github.com/WZL0813/astrbot_plugin_wzl_mcstatus.git

# 大陆地区#2
git clone https://cdn.gh-proxy.com/https://github.com/WZL0813/astrbot_plugin_wzl_mcstatus.git
```
以上命令任选其一执行即可  
...
# 支持
[Ryokuryuneko](https://ryokuryuneko.top)
